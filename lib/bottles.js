...
class Bottles {
  ...
  verse(number) {
    switch (number) {
      case 0:
        return (
          `${capitalize(this.quantity(number).toString())} bottles of beer on the wall, ` +
      ...
      default:
        return (
          `${capitalize(this.quantity(number).toString())} ${this.container(number)} of beer on the wall, ` +
